...
// 3b. The member app (member.html) is generated from index.html so the
//     dedicated Church Connect install entry always matches the console and
//     carries the same-origin API marker. Never edit member.html by hand.
const memberHtmlPath = resolve(dist, 'member.html');
let memberHtml = indexHtml
  .replace('<body>', '<body data-app="member">')
  .replace(/href="manifest\.json\?v=\d+"/, 'href="member-manifest.json?v=1"');
memberHtml =
  '<!-- Church Connect member app (generated by scripts/build-cf.mjs from index.html - do not edit by hand) -->\n' +
  memberHtml;
writeFileSync(memberHtmlPath, memberHtml);
